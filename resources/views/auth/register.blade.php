                    ...
                    <div class="card z-index-0">
                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('register.perform') }}">
                                ...
                                {{-- <div class="flex flex-col mb-3">
                                    <div class="mb-3">
                                        <select class="form-select form-select-lg" name="religion_id" id="">
                                            @foreach ($religions as $religion)
                                                <option value="{{$religion->id}}" @selected(old('religion_id') == $religion->id)>{{ $religion->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="flex flex-col mb-3">
                                    <input type="number" name="contact" class="form-control" max="9999999999"
                                        min="0000000000" placeholder="Phone number" aria-label="contact"
                                        value="{{ old('contact') }}">
                                    @error('contact')
                                        <p class='text-danger text-xs pt-1'> {{ $message }} </p>
                                    @enderror
                                ...
                                <div class="form-check form-check-info text-start">
                                    ...
                                    <label class="form-check-label" for="flexCheckDefault">
                                        I agree the <a href="{{route('termsCondition')}}" class="text-dark font-weight-bolder">Terms and
                                            Conditions</a>
                                    </label>
                                    @error('terms')

            ...
            <div class="row">
                <div class="col-md-12 text-center">
                    <div class="hero-text-container">
                        <h1 class="hero-title">
                            <span class="hero-text-highlight">Change password</span>
                        </h1>
                    </div>
                </div>
            </div>
            ...
            <div class="col-xl-4 col-lg-5 col-md-7 d-flex flex-column mx-auto">
                <div class="card card-plain">
                    <div class="card-header pb-0 text-start">
                        ...
                        <p class="mb-0" style="color: #fff;">Set a new password for your email</p>
                        <br />
                        @if (session('succes'))
                    ...
                    <form role="form" method="POST" action="{{ route('change.perform') }}">
                            ...
                            <div class="text-left">
                                <button type="submit" class="btn btn-primary mt-4 mb-0" style="background-color: #6b30be; border-color: #6b30be;">Change Password</button>
                            </div>
                        </form>
                    </div>
                    <div id="alert">

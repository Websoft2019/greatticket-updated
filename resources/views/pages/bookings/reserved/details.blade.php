            ...
            <div class="col">
                <div class="card">
                    ...
                    <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    @php
                                        $cleanPhone = $order->phone
                                            ...
                                            : null;
                                        $whatsAppMessage = 'Hello, I am contacting you regarding your order.';
                                    @endphp

                                    @if ($cleanPhone)
                                        <a href="https://wa.me/{{ $cleanPhone }}?text={{ urlencode($whatsAppMessage) }}"
                                            target="_blank" class="btn btn-success d-flex align-items-center gap-2"
                                            title="Send WhatsApp message to {{ $order->phone }}">
                        ...
                        <form method="POST" onsubmit="confirm('Are you sure ?')" action="{{ route('bookings.reserved.update', $order) }}">
                            @csrf
                            @method('PUT')
                            <button type="submit" class="btn btn-success">Payment Completed</button>
                            <a href="{{ route('bookings.reserved.index') }}" class="btn btn-secondary">Back</a>
                        </form>
                    </div>
                </div>
            </div>
